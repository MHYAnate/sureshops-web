...
// Move the dashboard content here - this is the actual dashboard page
// Use the existing AdminDashboardPage content from the code context
"use client";
            ...
            <div className="space-y-3">
              {pendingVendors.slice(0, 5).map((vendor: any) => (
                ...
                >
                  ...
                  <Button size="sm" asChild>
                    <Link href={`/admin/vendors?id=${vendor.id || vendor._id}`}>
                      Review
                    </Link>
                  </Button>
                </div>
            ...
            <div className="space-y-3">
              {pendingProducts.slice(0, 5).map((product: any) => (
                ...
                >
                  ...
                  <Button size="sm" asChild>
                    <Link href={`/admin/products?id=${product.id || product._id}`}>
                      Review
                    </Link>
                  </Button>
                </div>
